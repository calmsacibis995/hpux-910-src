/*	@(#)yp_prot.h	$Revision: 1.25.109.1 $	$Date: 91/11/19 14:43:18 $  */

/*      (c) Copyright 1987 Hewlett-Packard Company  */
/*      (c) Copyright 1985 Sun Microsystems, Inc.   */

#ifndef _RPCSVC_YP_PROT_INCLUDED
#define _RPCSVC_YP_PROT_INCLUDED

/*
 * This file contains symbols and structures defining the rpc protocol
 * between the Network Information Service clients and the Network Information
 * Service servers. The servers are the NIS database servers and the NIS binders.
 */
...
#define YPMAXPEER	((u_long)64)
#define YPMAX_TRANSID	((u_long)100000000)
...
#ifdef YP_CACHE
#define YPPROC_CLEARMAP	((u_long)107)
#ifdef YP_UPDATE
#define YPPROC_UPDATE_MAPENTRY	((u_long)105)
#define YPPROC_UPDATE_MAP	((u_long)106)
#endif /* YP_UPDATE */
#endif /* YP_CACHE */
...
/* YP_UPDATE MERGE entry point - prabha */
#ifdef YP_UPDATE
#define YPUPDATEPROC_MERGE	((u_long) 99)
#endif /* YP_UPDATE */
#endif /* RPCSVC_YP_PROT_INCLUDED */
