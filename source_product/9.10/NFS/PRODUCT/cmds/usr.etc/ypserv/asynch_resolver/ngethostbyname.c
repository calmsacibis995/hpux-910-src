/* $Source: /source/hpux_source/networking/rcs/nfs90_800/cmds/usr.etc/ypserv/asynch_resolver/RCS/ngethostbyname.c,v $
 * $Revision: 1.2.109.1 $	$Author: root $
 * $State: Exp $   	$Locker:  $
 * $Date: 94/05/25 10:52:20 $
 */

/*  $Header: ngethostbyname.c,v 1.2.109.1 94/05/25 10:52:20 root Exp $  */
static	char sccsid[] = "@(#)ngethostbyname.c	1.2 92/04/08 4.1NFSSRC";
#include <sys/param.h>
