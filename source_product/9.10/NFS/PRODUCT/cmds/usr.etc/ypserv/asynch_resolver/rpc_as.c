/* $Source: /source/hpux_source/networking/rcs/nfs90_800/cmds/usr.etc/ypserv/asynch_resolver/RCS/rpc_as.c,v $
 * $Revision: 1.2.109.1 $	$Author: root $
 * $State: Exp $   	$Locker:  $
 * $Date: 94/05/25 10:52:40 $
 */

/*  $Header: rpc_as.c,v 1.2.109.1 94/05/25 10:52:40 root Exp $  */
#if !defined(lint) && defined(SCCSIDS)
static	char sccsid[] = "@(#)rpc_as.c	1.1 90/07/23 4.1NFSSRC Copyright 1989 Sun Micro";
#endif
...
struct timeval rpc_as_get_timeout()
{
	...
	for (sock = 0; sock < FD_SETSIZE; sock += NFDBITS) 
		...
		if (x[i] != (struct rpc_as *) 0) {
			...
			if (x[i]->as_timeout_remain.tv_sec > 32766){
