/* $Source: /source/hpux_source/networking/rcs/nfs90_800/cmds/usr.etc/ypserv/asynch_resolver/RCS/nget_answer.c,v $
 * $Revision: 1.2.109.1 $	$Author: root $
 * $State: Exp $   	$Locker:  $
 * $Date: 94/05/25 10:52:18 $
 */

#if defined (LIBC_SCCS) && !defined(lint)
static	char sccsid[] = "@(#)nget_answer.c	1.2 92/06/05 4.1NFSSRC";
#endif
#include <sys/param.h>
