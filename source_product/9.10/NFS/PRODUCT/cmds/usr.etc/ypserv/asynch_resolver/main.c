/* $Source: /source/hpux_source/networking/rcs/nfs90_800/cmds/usr.etc/ypserv/asynch_resolver/RCS/main.c,v $
 * $Revision: 1.2.109.1 $	$Author: root $
 * $State: Exp $   	$Locker:  $
 * $Date: 94/05/25 10:52:16 $
 */

/*      $Header: main.c,v 1.2.109.1 94/05/25 10:52:16 root Exp $  */
/*	@(#)main.c	1.1 90/07/23 4.1NFSSRC	*/
#include <sys/param.h>
