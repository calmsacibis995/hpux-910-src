/* @(#)rpc.lockd:	$Revision: 1.5.109.3 $	$Date: 94/10/21 10:36:35 $
*/
/* (#)prot_lock.h	1.1 87/08/05 3.2/4.3NFSSRC */
/* (#)prot_lock.h	1.2 86/12/30 NFSSRC */
/*
...
struct reclock {
	...
	struct {
		int    port;  /* Port on kernel for this request */
		u_long xid;   /* xid of request */
	} connect_info;	/* Info needed to talk to kernel */
	/* various links */
