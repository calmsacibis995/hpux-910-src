/* @(#)automount:	$Revision: 1.4.109.3 $	$Date: 92/07/28 15:11:36 $
*/
...
struct autodir {
	...
	bool_t  dir_busy;	/* HPNFS - umount returned EBUSY */
...
extern int mount_timeout;	/* max seconds to wait for mount */
extern int max_link_time;	/* seconds to keep link around */
