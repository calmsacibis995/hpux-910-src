/* $Source: /source/hpux_source/networking/rcs/nfs90_800/cmds/usr.etc/yp/RCS/mkalias.c,v $
 * $Revision: 1.2.109.1 $	$Author: craig $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/11/01 11:05:40 $
 */

#ifndef lint
static char rcsid[] = 	"@(#)mkalias.c  $Revision: 1.2.109.1 $ $Date: 93/11/01 11:05:40 $ ";
#endif
/* static char sccsid[] =  "@(#)mkalias.c  1.2 90/07/23 4.1NFSSRC Copyr 1990 Sun Micro"; */
/*
