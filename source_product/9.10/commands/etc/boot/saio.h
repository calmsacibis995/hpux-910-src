...
/*
 *  MAXBSIZE changed in kernel header file and broke /etc/boot, so
 *  defined this local MAX_BSIZE to keep /etc/boot working.
 */
#ifdef SDS
#define MAX_BSIZE 16384
#else /* ! SDS */
#define MAX_BSIZE 8192
#endif /* else ! SDS */
...
struct	iob {
	...
	char	i_buf[MAX_BSIZE];/* i/o buffer */
	union {
...
#define F_ISATAPE       0x10000 /* Device is a tape */
