...
/* obsolete items listed below should not be used and will be reassigned */
unsigned char	*__C_langinfo[_NL_MAX_MSG+1] = {
	...
	(unsigned char *)"",				/* ERA_D_FMT	*/
	(unsigned char *)"ROMAN8",			/* CODESET	*/
	(unsigned char *)"C",				/* LANGNAME -obsolete */
	(unsigned char *)"",				/* REVISION -obsolete */
	(unsigned char *)"99",				/* LANGID -obsolete   */
	(unsigned char *)"",				/* CODE_SCHEME-obsolet*/
	(unsigned char *)"",				/* CSWIDTH	*/
	(unsigned char *)"",				/* CONTEXT -obsolete  */
	(unsigned char *)"\\",				/* ESC_CHAR -obsolete */
	(unsigned char *)"#",				/* COMM_CHAR -obsolete*/
	(unsigned char *)"",				/* CHARMAP	*/
	(unsigned char *)"^[yY]",			/* YESEXPR	*/
	(unsigned char *)"^[nN]",			/* NOEXPR	*/
	(unsigned char *)"%I:%M:%S %p",			/* T_FMT_AMPM	*/
	(unsigned char *)"",				/* ALT_DIGITS	*/
	(unsigned char *)"",				/* ERA		*/
	(unsigned char *)"",				/* ERA_D_T_FMT	*/
	(unsigned char *)""				/* ERA_T_FMT	*/
	};
