/* $Source: /misc/source_product/9.10/commands.rcs/lib/libc/rpc/xdr.c,v $
 * $Revision: 12.4 $	$Author: indnetwk $
 * $State: Exp $   	$Locker:  $
 * $Date: 92/06/12 16:00:28 $
 */
...
static char rcsid[] = "@(#) $Header: xdr.c,v 12.4 92/06/12 16:00:28 indnetwk Exp $ (Hewlett-Packard)";
#endif
 ...
 *
 * Algorithm
 *	{ open message catalog ifndef KERNEL
 *	  switch(xdrs->x_op) {
