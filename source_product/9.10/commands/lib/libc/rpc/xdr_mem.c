/* $Source: /misc/source_product/9.10/commands.rcs/lib/libc/rpc/xdr_mem.c,v $
 * $Revision: 12.1 $	$Author: dlr $
 * $State: Exp $   	$Locker:  $
 * $Date: 90/03/20 13:53:24 $
 */
...
static char rcsid[] = "@(#) $Header: xdr_mem.c,v 12.1 90/03/20 13:53:24 dlr Exp $ (Hewlett-Packard)";
#endif
...
#else /* defined hpux && ! defined KERNEL */
	bcopy(xdrs->x_private, addr, len);
#endif /* defined hpux && ! defined KERNEL */
	xdrs->x_private += len;
	return (TRUE);
}
