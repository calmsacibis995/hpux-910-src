/* $Source: /misc/source_product/9.10/commands.rcs/lib/libc/crt/qfsub.c,v $
 * $Revision: 64.1 $     $Author: sje $
 * $State: Exp $        $Locker:  $
 * $Date: 89/02/09 11:08:12 $
 *
 * $Log:	qfsub.c,v $
 * Revision 64.1  89/02/09  11:08:12  11:08:12  sje
 * Initial S300 version
 * 
 * Revision 1.2  88/01/21  17:10:53  17:10:53  liz (Liz Peters)
 * Changed entry point name.
 * 
 * Revision 1.1  87/10/08  13:36:52  13:36:52  liz (Liz Peters)
 * Initial revision
 * 
 * $Endlog$
 * 
...
static char rcsid[] = "$Header: qfsub.c,v 64.1 89/02/09 11:08:12 sje Exp $";
static char hpid[] = "HP Proprietary";

/*
 * Quad_subtract: subtract two quad precision values.
 */
_U_qfsub(leftptr, rightptr, dstptr, status)
