/*
 * @(#)sgl_float.h: $Revision: 64.1 $ $Date: 89/02/09 11:22:20 $
 * $Locker:  $
 * 
 */
/******************************
...
#define Sgl_is_signalingnan(sgl_value) (Ssignalingnan(sgl_value)==0x1fe)
#else
#define Sgl_isone_signaling(sgl_value) (Is_ssignaling(sgl_value)!=0)
...
#ifdef __hp9000s300
#define Sgl_iszero_signaling(sgl_value) (Is_ssignaling(sgl_value)==1)
#else
...
#ifdef __hp9000s300
#define Sgl_set_quiet(sgl_value) Deposit_shigh2mantissa(sgl_value,2)
#else
