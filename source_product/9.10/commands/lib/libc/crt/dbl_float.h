/*
 * @(#)dbl_float.h: $Revision: 64.1 $ $Date: 89/02/09 11:22:05 $
 * $Locker:  $
 * 
 */
/**************************************
...
#define Dbl_is_signalingnan(dbl_value) (Dsignalingnan(dbl_value)==0xffe)
#else
#define Dbl_isone_signaling(dbl_value) (Is_dsignaling(dbl_value)!=0)
...
#ifdef __hp9000s300
#define Dbl_set_quiet(dbl_value) Deposit_dhigh2mantissa(dbl_value,2)
#else
