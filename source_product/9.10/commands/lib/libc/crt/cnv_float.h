/*
 * @(#)cnv_float.h: $Revision: 64.1 $ $Date: 89/02/09 11:22:02 $
 * $Locker:  $
 * 
 */
...
#define Dbl_to_sgl_denormalized(srcA,srcB,exp,dest,inexact,guard,sticky,odd) \
    Deposit_dsignexponent(srcA,1);					\
    if (exp >= -2) {							\
