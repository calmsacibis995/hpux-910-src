...
char *id, **area;
{
	...
	case two('m','l'): rv = memory_lock; break;
	case two('m','u'): rv = memory_unlock; break;
	...
	case two('p','O'): rv = prtr_non; break;
 	case two('p','n'): rv = plab_norm; break;
 	case two('L','O'): rv = label_on; break;
 	case two('L','F'): rv = label_off; break;
	case two('F','1'): rv = key_f11; break;
	case two('F','2'): rv = key_f12; break;
	case two('F','3'): rv = key_f13; break;
	case two('F','4'): rv = key_f14; break;
	case two('F','5'): rv = key_f15; break;
	case two('F','6'): rv = key_f16; break;
	case two('F','7'): rv = key_f17; break;
	case two('F','8'): rv = key_f18; break;
	case two('F','9'): rv = key_f19; break;
	case two('F','A'): rv = key_f20; break;
	case two('F','B'): rv = key_f21; break;
	case two('F','C'): rv = key_f22; break;
	case two('F','D'): rv = key_f23; break;
	case two('F','E'): rv = key_f24; break;
	case two('F','F'): rv = key_f25; break;
	case two('F','G'): rv = key_f26; break;
	case two('F','H'): rv = key_f27; break;
	case two('F','I'): rv = key_f28; break;
	case two('F','J'): rv = key_f29; break;
	case two('F','K'): rv = key_f30; break;
	case two('F','L'): rv = key_f31; break;
	case two('F','M'): rv = key_f32; break;
	case two('F','N'): rv = key_f33; break;
	case two('F','O'): rv = key_f34; break;
	case two('F','P'): rv = key_f35; break;
	case two('F','Q'): rv = key_f36; break;
	case two('F','R'): rv = key_f37; break;
	case two('F','S'): rv = key_f38; break;
	case two('F','T'): rv = key_f39; break;
	case two('F','U'): rv = key_f40; break;
	case two('F','V'): rv = key_f41; break;
	case two('F','W'): rv = key_f42; break;
	case two('F','X'): rv = key_f43; break;
	case two('F','Y'): rv = key_f44; break;
	case two('F','Z'): rv = key_f45; break;
	case two('F','a'): rv = key_f46; break;
	case two('F','b'): rv = key_f47; break;
	case two('F','c'): rv = key_f48; break;
	case two('F','d'): rv = key_f49; break;
	case two('F','e'): rv = key_f50; break;
	case two('F','f'): rv = key_f51; break;
	case two('F','g'): rv = key_f52; break;
	case two('F','h'): rv = key_f53; break;
	case two('F','i'): rv = key_f54; break;
	case two('F','j'): rv = key_f55; break;
	case two('F','k'): rv = key_f56; break;
	case two('F','l'): rv = key_f57; break;
	case two('F','m'): rv = key_f58; break;
	case two('F','n'): rv = key_f59; break;
	case two('F','o'): rv = key_f60; break;
	case two('F','p'): rv = key_f61; break;
	case two('F','q'): rv = key_f62; break;
	case two('F','r'): rv = key_f63; break;
	default: rv = NULL;
	}

	/* for backward termcap compatibility: */
	if (area != (char **)0 && *area != (char *)0 && rv != (char *)0) {
		strcpy(*area,rv);
		*area += strlen(*area) + 1; /* advance the area pointer */
	}
