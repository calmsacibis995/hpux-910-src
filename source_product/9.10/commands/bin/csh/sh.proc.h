...
/*  From sh.dir.h, a directory structure:
            
	    struct directory
	      {
		directory *di_next;
		directory *di_prev;
		unsigned short *di_count;
		unsigned short *di_name;
	      }
*/
...
struct process	{
	...
	char	p_leader;		/* true if first job in a pipe */
...
#endif
#ifndef NONLS
	unsigned short *p_command;	/* first PMAXLEN chars of command */
#else
