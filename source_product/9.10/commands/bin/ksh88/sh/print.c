 ...
 *
 * argn        is the number of items to print
 * com         the items to print
 * zero_flag   if set, then start numbering at 0
 */
...
void	p_list(argn,com,zero_flag)
const char *com[];
int zero_flag;
{
	register int i,j;
