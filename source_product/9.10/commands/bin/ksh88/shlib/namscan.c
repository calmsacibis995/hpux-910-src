...
#include        "defs.h"           /* defs.h includes name.h */
                                   /* this is for referring st struct*/
 ...
 * The original way of doing things - this broke typeset <var name>
 * releasing namespace after the function is through. See DTS UCSqm00357
 */
					if((nam_istype(np,~N_DEFAULT)==0)&&!(st.states&&FUNCTION))
						continue;
				if(fn)
				{
