...
#   define	HP_TTYGRP	42
#   define	HP_PID		43
#   define 	HP_VERSION	44
#   define	HP_SIGHAND	47
#   define      HP_GETLOCALE	48
#endif /* HP_BUILTIN */
#ifdef POSIX2
#   define	SYSCOMMAND	45
#endif /* POSIX2 */
#ifdef RFA
#   define	SYSNETUNAM	46
#endif /* RFA */
...
/* ERRNO is 27 */
/* LINENO is 28 */
#define OPTINDNOD	(sh.bltin_nodes+29)
/* OPTARG is 30 */
...
#define LCCOLLATENOD	(sh.bltin_nodes+35)
#ifdef VPIX
...
#ifdef HP_BUILTIN
extern const struct sysnod	tab_hp_builtins[];
#endif /* HP_BUILTIN */
