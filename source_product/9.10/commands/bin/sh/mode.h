...
/*  NLS 16 stuff
 *  tchar stands for true character since it always contains a char regardless 
 *  of whether that character is 7, 8 or 16 bits long.
 */
#ifndef NLS	
#define tchar char
#else   NLS
