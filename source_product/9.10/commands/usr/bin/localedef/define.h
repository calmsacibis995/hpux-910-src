...
#define MAX_COLL_ELEMENT 30             /* arbit number for collating element */
...
#define MAX_COLL        5               /* used in coll.c for string */

#define LANG2BYTE	(strcmp((char *)info_tab[BYTES_CHAR], "2") ? 0 : 1)
#define xisprint(c)    (ctype5[c]&(_PR)) /*	(ctype1[c]&(_P|_U|_L|_N|_B)) */
