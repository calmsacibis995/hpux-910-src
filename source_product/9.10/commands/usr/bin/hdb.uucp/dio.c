...
/*	/sccs/src/cmd/uucp/s.dio.c
	dio.c	1.2	7/29/85 16:32:52
*/
#include "uucp.h"
...
DEBUG(4, (catgets(nlmsg_fd,NL_SETN,459, "dturnon: ret=%d, ")), ret);
DEBUG(4, (catgets(nlmsg_fd,NL_SETN,460, "Ofn=%d, ")), Ofn);
DEBUG(4, (catgets(nlmsg_fd,NL_SETN,461, "errno=%d\n")), errno);
		return(-1);
}
	return(0);
}
