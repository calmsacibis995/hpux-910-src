...
#define NONAP /* define NONAP if you have no high-resolution sleep call */

/* #define FASTTIMER "/dev/ft"   /* */
...
/* define DUMB_DN if your dn driver (801 acu) doesn't handle '=' */
/* #define DUMB_DN /*  */
 ...
 */
/* define to use /usr/spool/locks for LCK files */
/*#define USRSPOOLLOCKS  */ /* Just to be a little bit more backward compatible*/
