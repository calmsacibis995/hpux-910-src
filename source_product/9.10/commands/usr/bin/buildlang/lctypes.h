...
#define N_CATEGORY	6		/* number of defined categories */
...
struct lctable_header {
	...
	char lang[NL_LANGMAX+1];	/* language name */
	...
	char rev_str[MAXRSTRLEN];	/* revision string */
#ifdef EUC
...
struct catinfotype 
{
	...
	char mod_name[_POSIX_NAME_MAX+1];	/* name of modifier */
...
struct lcctype_header {
	...
	unsigned short byte_char_addr;	/* __nl_info[BYTES_CHAR] */
	unsigned short alt_punct_addr;	/* __nl_info[ALT_PUNCT] */
					/* _nl_punct_alt[] */
					/* _nl_space_alt   */
#ifdef EUC
