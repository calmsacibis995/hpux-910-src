...
#define LINESIZE        2*BUFSIZ        /* max readable line width */
#define	STRINGSIZE	((unsigned) 128)/* Dynamic allocation units */
#define	MAXARGC		100		/* Maximum list of raw strings */
#define	NOSTR		((char *) 0)	/* Null string pointer */
#define	MAXEXP		25		/* Maximum expansion of aliases */
#define GENBUFSIZ       1024            /* Use instead of BUFSIZ, because */
					/* BUFSIZ may change to 4k or 8k. */
#define MAX_COUNT	10
#ifdef NLS
#define PBIT		2		/* Set when send() function is */
#endif NLS
					/* called by print() (for NLS) */
#define IN		0
#define OUT		1
...
struct message {
	...
	unsigned long	m_lines;		/* Lines in the message */
};
...
#define GREPLYTO        16      /* And also the Reply-to: line */
#define GMASK   (GTO|GSUBJECT|GCC|GBCC|GREPLYTO)
...
struct header {
	...
	char    *h_replyto;             /* Reply-To address     */
 ...
 * for read/write.  Change associated open modes if truncate
 * doesn't work.
 */
