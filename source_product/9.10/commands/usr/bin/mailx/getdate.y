...
/* #include "defs.h" - Not needed currently */
...
struct table mztab[] = {
	...
	{"utc", ZONE, 0 HRS}, 		/* Added for DSDe414531 */
	{"u.t.c.", ZONE, 0 HRS}, 	/* Added for DSDe414531 */
...
time_t mailx_getdate(p, now) char *p; struct timeb *now;
{
