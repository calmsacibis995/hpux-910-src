...
** All Rights Reserved.							    **
*****************************************************************************/
/* @(#) $Header: foreign.c,v 70.1 92/03/09 15:42:25 ssa Exp $ */
/* #define DEBUG 1 */
#include "stdio.h"
...
/**************************************************************************
* load_foreign
*	If user specified text strings file is present, read the strings,
*	allocate memory for them, and point the default text string
*	pointers to the new strings.
**************************************************************************/
