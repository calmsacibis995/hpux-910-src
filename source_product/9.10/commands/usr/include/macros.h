...
#ifndef _MACROS_INCLUDED /* allow multiple inclusions */
 ...
 */
# define DEBUG(variable,type)\
	fprintf(stderr,"variable = %type\n",variable)

/*
 * Use: SCCSID(<id-string>) which becomes 
 *      static char Sccsid "<id-string>"
 * where <id-string> contains the desired Sccs-id substition string.
 */
