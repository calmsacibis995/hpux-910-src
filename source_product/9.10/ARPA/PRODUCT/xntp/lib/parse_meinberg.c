# if defined(PARSE) && defined(CLOCK_MEINBERG)
/*
 * $Header: parse_meinberg.c,v 1.2.109.2 94/10/31 10:45:17 mike Exp $
 *  
 * parse_meinberg.c,v 3.2 1993/07/09 11:37:16 kardel Exp
 *
 ...
 * This is Meinbergs GPS receiver.
 *
...
static struct format    meinberg_fmt[] =
{
	...
	0
        ...
        {			/* special extended FAU
				   Erlangen extended format
				   */
	    {
	        {
		1, 2
...
clockformat_t   clock_meinberg[] =
{
	...
	cvt_meinberg,		/* Meinberg conversion */
	    syn_simple,		/* easy time stamps for
				   RS232 (fallback) */
	...
	/* conversion configuration */
	    "Meinberg Standard",/* Meinberg simple format -
				   beware */
	    32,			/* string buffer */
	    F_START | F_END | SYNC_START | SYNC_ONE,
	/* paket START/END delimiter, START
	   synchronisation, PPS ONE sampling */
	    {
	    0, 0
	    },
	    '\2',
