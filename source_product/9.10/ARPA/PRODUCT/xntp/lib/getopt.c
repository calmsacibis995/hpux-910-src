/* $Header: getopt.c,v 1.2.109.2 94/10/28 17:27:56 mike Exp $
 ...
 */
# ifndef	__convex__
int     opterr = 1;		/* for compatibility,
				   should error be printed? 
				*/
# else				/* __convex__ */
extern int  opterr;		/* for compatibility,
				   should error be printed? 
				*/
# endif				/* __convex__ */
int     optopt;			/* for compatibility,
