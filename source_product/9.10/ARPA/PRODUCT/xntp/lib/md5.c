/* $Header: md5.c,v 1.2.109.2 94/10/28 17:38:17 mike Exp $
 ***********************************************************************
...
# else	/* ! defined (FAST_MD5) && defined(__GNUC__) && defined(mc68000) */
# 	define ROTATE_LEFT(x, n) (((x) << (n)) | ((x) >> (32-(n))))
# endif	/* defined (FAST_MD5) && defined(__GNUC__) && defined(mc68000) */
