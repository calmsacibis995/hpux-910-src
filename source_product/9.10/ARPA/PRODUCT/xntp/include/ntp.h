/* 
 *  $Header: ntp.h,v 1.2.109.2 94/10/28 16:34:07 mike Exp $
...
#define	NTP_MAXSTRATUM	15	/* max stratum, infinity a la Bellman-Ford */
...
#define	CLOCK_FREQ	20	/* log2 frequency weight (1048576) */
#define	CLOCK_PHASE	8	/* log2 phase weight (256) */
...
#define	STRATUM_INFIN	NTP_MAXSTRATUM	/* infinity a la Bellman-Ford */
/* A stratum of 0 in the packet is mapped to 16 internally */
#define	STRATUM_PKT_UNSPEC	0	/* unspecified in packet */
#define	STRATUM_UNSPEC	(NTP_MAXSTRATUM+1) /* unspecified */
...
#define	SYSEVENT	1
#define CLKEVENT	2
struct event_strings {
       int	event_num;
    	char    *event_description;
};

extern struct event_strings sys_event_str[];
extern struct event_strings clk_event_str[];
#endif hpux
