/* $Header: ntp_intres.c,v 1.2.109.3 94/11/09 10:35:39 mike Exp $
...
struct conf_entry
{
    ...
    char   *ce_name;		/* name we are trying to
				   resolve */
...
static int  resolve_value;	/* next value of resolve
				   timer */

/*
 * Big hack attack
 */
# define	LOCALHOST	0x7f000001  /* 127.0.0.1, in hex, of
				   course */
# define	SKEWTIME	0x08000000  /* 0.03125 seconds as a
				   l_fp fraction */
...
char   *req_file;		/* name of the file with
				   configuration info */
...
struct conf_entry  *entry;
{
    ...
    checkparent ();		/* make sure our guy is
				   still running */
