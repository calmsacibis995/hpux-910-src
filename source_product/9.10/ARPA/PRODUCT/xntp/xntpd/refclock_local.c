/*
 * $Header: refclock_local.c,v 1.2.109.3 94/11/09 10:57:08 mike Exp $
 ...
 */
# 	define	LCLDISPERSION	(FP_SECOND/5)
				/* 200 ms dispersion */
# 	define	LCLROOTDISPERSION (FP_SECOND/5)
				/* 200 ms root dispersion 
				*/
# 	define	LCLPRECISION	(-5)	/* what the heck */
# 	define	LCLREFID	"LCL\0"
# 	define	LCLREFOFFSET	20	/* reftime is 20s behind */
# 	define	LCLHSREFID	0x7f7f0101
				/* 127.127.1.1 refid for hi
				   stratum */
