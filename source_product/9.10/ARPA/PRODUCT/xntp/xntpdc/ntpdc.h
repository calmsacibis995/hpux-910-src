/*
 * $Header: ntpdc.h,v 1.2.109.2 94/11/03 15:50:35 mike Exp $
 */
 ...
 */
# define	OPT	0x80		/* this argument is
				   optional, or'd with type
				   */
...
struct xcmd
{
    ...
    void ( *handler) P ((struct parse  *, FILE *));
				/* command handler */
    u_char  arg[MAXARGS];	/* descriptors for
				   arguments */
    char   *desc[MAXARGS];	/* descriptions for
				   arguments */
    char   *comment;
};
