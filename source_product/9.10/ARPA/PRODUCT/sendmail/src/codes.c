# ifndef lint
static char rcsid[] = "$Header: codes.c,v 1.2.109.5 95/02/24 16:29:22 mike Exp $";
# endif /* not lint */

# ifdef PATCH_STRING
static char *patch_3997="@(#) PATCH_9.03: codes.o $Revision: 1.2.109.5 $ 94/03/24 PHNE_3997";
# endif	/* PATCH_STRING */
...
/* the following gets a character, but fakes it properly into two chars if
 ...
 * Since we're no longer ever calling it with anything signed,
 * this should work:
 */
