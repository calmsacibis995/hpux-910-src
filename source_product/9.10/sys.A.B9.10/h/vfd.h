...
#ifndef	MALLOC_VFDS
/* subtract one chunk per page since last entry is next chunk pointer */
#define CHUNKS_PER_PAGE ((NBPG/(sizeof(chunk_t)))-1)
#endif	
...
#else	
	chunk_t *	/* most recently allocated page */
		b_list;
#endif	
...
#ifndef	MALLOC_VFDS
/* # of chunks/bnodes in a page */
#define NFRAG (NBPG/sizeof(chunk_t))
#endif	
