...
#else
		long	ic_spare[3];	/* 116: reserved, currently unused */
#endif
#ifdef ACLS
	    } i_ic;
	    struct icont
...
#define	i_db		i_ic.ic_un2.ic_reg.ic_db
#define	i_ib		i_ic.ic_un2.ic_reg.ic_un.ic_ib
#define	i_atime		i_ic.ic_atime
#define	i_mtime		i_ic.ic_mtime
#define	i_ctime		i_ic.ic_ctime
#define i_symlink	i_ic.ic_un2.ic_symlink
#define i_flags		i_ic.ic_flags
#define i_blocks	i_ic.ic_blocks
/*  Define 1) new name for real device number 2) name for device site # */
#define i_device        i_ic.ic_un2.ic_reg.ic_db[0]
#define i_rsite         i_ic.ic_un2.ic_reg.ic_db[2]
...
#define	i_freef		i_fr.if_freef
#define	i_freeb		i_fr.if_freeb
#define i_frptr		i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_frptr
#define i_fwptr		i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_fwptr
#define i_frcnt		i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_frcnt
#define i_fwcnt		i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_fwcnt
#define i_fflag		i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_fflag
#define i_fifosize	i_ic.ic_un2.ic_reg.ic_un.ic_fifo.if_fifosize
#define i_fifo		i_ic.ic_un2.ic_reg.ic_un.ic_fifo
#define i_fversion	i_ic.ic_fversion
#endif /* ACLS */
