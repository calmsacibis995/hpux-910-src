/*
 * @(#)fs.h: $Revision: 1.17.83.4 $ $Date: 94/05/19 13:48:04 $
 * $Locker:  $
 * 
 */
...
#if defined(PF_ASYNC) || defined(UFS_GETSB)
/*
 *	fsctl command(s)
 */
#define UFS_GET_SB	0x21
#define UFS_SET_ASYNC	0x22
#define UFS_CLEAR_ASYNC 0x23
#endif		/*  PF_ASYNC or UFS_GETSB  */
