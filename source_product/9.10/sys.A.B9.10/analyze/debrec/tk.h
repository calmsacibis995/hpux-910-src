/*
 * @(#)tk.h: $Revision: 1.2.83.3 $ $Date: 93/09/17 16:23:51 $
 * $Locker:  $
 */

/*
 * Original version based on: 
 * Revision 62.4  88/04/20  08:41:38  08:41:38  sjl (Steve Lilker)
 */
...
#define tkLEQU          94      /* .EQU. FORTRAN only      */
#define tkLNEQU         95      /* .NEQU. FORTRAN only     */
#define tkOf           120      /* OF operator, Cobol only */
#define tkTo           121      /* TO operator, Cobol only */
...
/*
 * PRE-DEFINED LANGUAGE CONSTANTS
 */

#define tkFTrue		113	/* FORTRAN ".TRUE."	   */
#define tkFFalse	114	/* FORTRAN ".FALSE."       */
#define tkPNil		115	/* Pascal NIL		   */
#define tkPMaxint	116	/* Pascal Maxint	   */
#define tkPMinint	117	/* Pascal Minint	   */
#define tkPTrue		118	/* Pascal True		   */
#define tkPFalse	119	/* Pascal False		   */
#define tkCblSpaces	122	/* Cobol "spaces"	   */
#define tkCblZeros	123	/* Cobol "zeros"	   */
...
#define lcPNil	  0
#define lcPMaxint  0x7fffffff
#define lcPMinint  0x80000000
#define lcPTrue   1
#define lcPFalse  0

  /* Cobol */

#define lcCblSpaces  0
#define lcCblZeros   1
