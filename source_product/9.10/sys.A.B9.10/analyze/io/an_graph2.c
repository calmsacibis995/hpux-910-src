...
/***************************************************************************/
/**                                                                       **/
/**  This is the I/O manager analysis routine for the graph2 port server  **/
/**                                                                       **/
/***************************************************************************/
...
#include <h/types.h> 
#include <sio/llio.h>
#include <sio/graph02.h>		/* graph2's normal .h file	     */
#include "aio.h"			/* all analyze i/o defs		     */

#define AN_WHICH_GRAPH          2
static  char *me              = "graph2";
static  char *my_rev_var_name = "graph2_an_rev";
int     graph2_an_rev         = 4;	/* global -- rev number of graph2 DS */



int an_graph2 (call_type, port_num, out_fd, option_string)
...

{
    ...
    switch (call_type)  {
	case AN_MGR_INIT:
	    an_graph02_check_revs (me, my_rev_var_name, graph2_an_rev, out_fd);
	    break;
	case AN_MGR_BASIC:
