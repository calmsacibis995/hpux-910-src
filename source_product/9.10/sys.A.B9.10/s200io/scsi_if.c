/* $Source: /source/hpux_source/kernel/sys.SWT68K_300/s200io/RCS/scsi_if.c,v $
 * $Revision: 1.11.84.6 $	$Author: paul $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/09 17:41:41 $
 */
...
"@(#) PATCH 9.0: scsi_if.c $Revision: 1.11.84.6 $ $Date: 93/12/09 17:41:41 $";
#endif /* SCSI_IF_PATCH */
