/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/xdr_array.c,v $
 * $Revision: 1.8.83.4 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/06 22:49:43 $
 */
...
static char rcsid[] = "@(#) $Header: xdr_array.c,v 1.8.83.4 93/12/06 22:49:43 marshall Exp $ (Hewlett-Packard)";
#endif
