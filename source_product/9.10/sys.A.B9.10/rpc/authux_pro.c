/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/authux_pro.c,v $
 * $Revision: 1.7.83.4 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/06 22:48:33 $
 */
...
static char rcsid[] = "@(#) $Header: authux_pro.c,v 1.7.83.4 93/12/06 22:48:33 marshall Exp $ (Hewlett-Packard)";
#endif
