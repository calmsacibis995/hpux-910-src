/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/rpc_prot.c,v $
 * $Revision: 1.7.83.4 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/06 22:48:49 $
 */
...
static char rcsid[] = "@(#) $Header: rpc_prot.c,v 1.7.83.4 93/12/06 22:48:49 marshall Exp $ (Hewlett-Packard)";
#endif
