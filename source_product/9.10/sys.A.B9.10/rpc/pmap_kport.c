/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/pmap_kport.c,v $
 * $Revision: 1.4.83.3 $	$Author: kcs $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/09/17 19:27:09 $
 */
...
u_short port;
{
    ...
    if ( in_pcblookup(&udb,inaddr_any,0,inaddr_any,port,INPLOOKUP_WILDCARD) )
	return(1);
