/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/svc_authux.c,v $
 * $Revision: 1.7.83.4 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/06 22:49:20 $
 */
...
static char rcsid[] = "@(#) $Header: svc_authux.c,v 1.7.83.4 93/12/06 22:49:20 marshall Exp $ (Hewlett-Packard)";
#endif
