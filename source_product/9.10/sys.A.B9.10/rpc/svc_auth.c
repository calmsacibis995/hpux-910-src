/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/rpc/RCS/svc_auth.c,v $
 * $Revision: 1.8.83.4 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/06 22:49:13 $
 */
...
static char rcsid[] = "@(#) $Header: svc_auth.c,v 1.8.83.4 93/12/06 22:49:13 marshall Exp $ (Hewlett-Packard)";
#endif
