#ifdef MODULE_ID
/*
 * @(#)fifo.h: $Revision: 1.5.83.4 $ $Date: 93/09/17 19:06:52 $
 * $Locker:  $
 */
#endif /* MODULE_ID */
 ...
 */
/* NOTE: Sun's size is 4096.  We use PIPSIZ to match the rest of HP-UX */
#define FIFOBUF	PIPSIZ	/* max # bytes stored in a fifo */
#define FIFOMAX ~0	/* largest size of a single write to a fifo */
#define FIFOBSZ PIPSIZ	/* number of data bytes in each fifo data buffer */
