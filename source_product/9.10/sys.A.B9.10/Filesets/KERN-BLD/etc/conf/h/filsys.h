/* @(#) $Revision: 1.11.83.5 $ */       
/* $Source: /source/hpux_source/kernel/sys.SWT68K_800/h/RCS/filsys.h,v $
 * $Revision: 1.11.83.5 $	$Author: marshall $
 * $State: Exp $   	$Locker:  $
 * $Date: 93/12/08 18:23:38 $
 */
#ifndef _SYS_FILSYS_INCLUDED
#define _SYS_FILSYS_INCLUDED
...
#ifdef __hp9000s800
/* UNISRC_ID	filsys.h	25.1	84/07/20  */

/* 
 * This file is an import from Bell 5.2 because Emerald needs it.  Also,
 * customer code imported from Bell may #include it.  Unfortunately, this
 * structure has changed for hpux on HP Precision Architecture. 
 * (See <sys/fs.h>.)  Our first attempt will be to have this file empty 
 * for the hpux implementation on HP Precision Architecture.  Consequently,
 * once the compiler complains at the user, the user will have to change 
 * his code to #include <sys/fs.h>.  
 *
 * For series 300 portability, see also <sys/param.h>.
 */
#endif /* __hp9000s800 */

#endif /* _SYS_FILSYS_INCLUDED */
